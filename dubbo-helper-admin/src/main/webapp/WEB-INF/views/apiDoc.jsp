    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href=<%=basePath %>apiDoc>应用列表</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <c:forEach items="${serviceList}" var="service" varStatus="order">
                        ...
                        <div>
                            <a class="%s" href="<%=basePath %>apiDoc/method?service=${service.className}&packageName=${packageName}">${service.className}</a>
                        </div>
                    </c:forEach>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <c:if test="${not empty interfaceList}">
                        <c:forEach items="${interfaceList}" var="interfaceDetail" varStatus="order">
                            ...
                            <div>
                                <a class="%s" href="<%=basePath %>apiDoc/document?service=${currentService}&method=${interfaceDetail.methodName}&packageName=${packageName}">${interfaceDetail.methodName}</a>
                            </div>
                        </c:forEach>
                    </c:if>
                </div>
